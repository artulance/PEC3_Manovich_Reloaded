...
Si lo miramos con las *"gafas de Manovich"*, lo que vemos es un encuentro de técnicas que antes pertenecían a medios completamente distintos, tal como él describe (Manovich, 2013, p191). Por un lado tenemos las técnicas del medio musical: loops de audio, samples patrones rítmicos. Por otro, las técnicas de la animación gráfica: los personajes reaccionan visualmente a los sonidos que producen, creando una conexión directa entre lo que se ve y lo que se oye. Por encima de todo esto, están las técnicas del diseño de juegos: hay reglas, hay objetivos ocultos (si combinas ciertos sonidos en el orden correcto, se desbloquean animaciones bonus) y hay una sensación de descubrimiento que te engancha y te invita a seguir probando combinaciones.

En un reproductor de música convencional, el sonido va por un lado y la imagen de la carátula va por otro, conviven pero no se mezclan. Incredibox representa claramente el tipo b) de hibridación que describe Manovich: la que se produce en la **interfaz de usuario**, ofreciendo nuevas maneras de navegar e interaccionar con los medios. La interfaz visual no es un añadido decorativo: es el propio instrumento musical y una instrucción de animación. Las técnicas exclusivas de la producción musical, del diseño de animación y del game design se han convertido en elementos de software que se combinan en una sola interfaz por vías que antes resultaban imposibles (Manovich, 2013, p174). No se puede separar un medio del otro: la lógica del juego es lo que estructura la experiencia compositiva.

Manovich habla mucho del principio de modularidad en el software: la idea de que los elementos funcionan como piezas independientes que pueden ser combinadas y recombinadas. En este caso, es literal ya que cada sonido es un módulo autónomo que el usuario puede añadir, quitar o sustituir libremente. El software establece las reglas de compatibilidad pero dentro de esas reglas el margen creativo es enorme. No se mezclan simplemente archivos de audio uno encima de otro sino que se hibridan las técnicas de la producción musical, del diseño de animación y del game design en un mismo entorno.
...
Si nos ponemos de nuevo las *"gafas de Manovich"*, lo que está ocurriendo aquí es exactamente lo que él describe como "El encuentro de diversas técnicas que anteriomente pertenecían a medios distintos" (Manovich, 2013, p174). Las técnicas del catálogo comercial, modelización 3D, la visión por computador y las de la fotografía en tiempo real se fusionan en una experiencia. No es que el usuario vea primero una foto, luego el modelo 3D, active la cámara... el software integra todo esto en un flujo continuo donde cada técnica alimenta a las demás.
